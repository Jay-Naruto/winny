...
<coin-stats-ticker-widget coin-id="trillioner" locale="en" currency="INR" background="#fff" text-color="#000" border-color="rgba(0,0,0,0.15)" type="medium" font="Redhat" height="149" width="350" rank-background="#FFA959" status-up-color="#74D492" status-down-color="#FE4747" rank-text-color="#1C1B1B" ></coin-stats-ticker-widget>
